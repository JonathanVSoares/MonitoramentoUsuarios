			...
			<div class='col-md-2 col-sm-12'>
				<ul class="list-group">
					...
					<a href='#' class="list-group-item"><span
						class="glyphicon glyphicon-globe"></span> Público</a>
						...
						<div class='row'>
							<div class='col-md-8 col-sm-12'>
								<br /> <img
									...
									style='width: 5%; height: 5%;' /> GRÁFICO DE COMPARAÇÕES
							</div>
							<div class='col-md-4 col-sm-12'>
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu">
										<li class="active"><a href="#">Últimos 7 dias</a></li>
		...
		<div class='col-md-10 col-sm-12 panel panel-default'>
			<div class='row'>
				...
				<div class='col-md-4 col-sm-12 panel panel-default'>
					...
					<div class='row'>
						<div class='col-md-10 col-sm-12'>
							<p style='color: #a3a3a3'>ARMÁRIO BRANCO</p>
						</div>
						<div class='col-md-1 col-sm-12'>
							<p style='color: #a3a3a3'>70%</p>
						</div>
					...
					<div class='row'>
						<div class='col-md-10 col-sm-12'>
							<p style='color: #a3a3a3'>CADEIRA DE PLÁSTICO</p>
						</div>
						<div class='col-md-1 col-sm-12'>
							<p style='color: #a3a3a3'>30%</p>
						</div>
