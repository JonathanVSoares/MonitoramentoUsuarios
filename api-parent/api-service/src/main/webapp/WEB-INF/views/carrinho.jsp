...
<!--Teste AB BOTÃO COMPRAR 10 produtos_final-->
...
<link rel="stylesheet" type="text/css"
	href="//assets.lojaskd.com.br/releases/production/dist/stylesheets/lkd-icons.min.css?v=09102017041541">
<link rel="stylesheet" type="text/css"
	href="//assets.lojaskd.com.br/releases/production/dist/stylesheets/fechamento.min.css?v=09102017041541">
...
<script language="javascript" type="text/javascript"
	src="//assets.lojaskd.com.br/releases/production/dist/javascripts/jquery.min.js?v=09102017041541"></script>
<script language="javascript" type="text/javascript"
	src="//assets.lojaskd.com.br/releases/production/dist/javascripts/bundle-utils.min.js?v=09102017041541"></script>
<script language="javascript" type="text/javascript"
	src="//assets.lojaskd.com.br/releases/production/dist/javascripts/jquery-migrate.min.js?v=09102017041541"></script>
...
<body id="lkdAreavip" itemscope itemtype="http://schema.org/WebPage"
	class="carrinho checkout">


	<!-- Google Tag Manager (noscript) -->
	<noscript>
		<iframe src="//www.googletagmanager.com/ns.html?id=GTM-D5WF"
		...
		<div id="regrasCampanha">
			<div class="flt_container">
				<div class="flt_back_container">
					<div class="flt_menu">
						<ul>
							<li title="Loja 100% Segura"><span
								class="selo-certificado imagem-bg"
								onclick="trackEvent(['Segurança','Rodapé','Certificado']); window.location.href = 'http://www.lojaskd.com.br/portal/seguranca-e-privacidade';"></span>Certificado
								<br> AlphaSSL</li>


							<li title="Navegação Segura Google"><span
								class="sfg imagem-bg"
								onclick="window.open('http://google.com/safebrowsing/diagnostic?hl=pt-PT&amp;site=lojaskd.com.br'); trackEvent(['Segurança','Rodapé','Google']);"></span>Google
								Safe <br>Browsing</li>
						</ul>
					</div>
				...
				<div class="flt_table">
					<div id="flt_dv_1" class="flt_content ct_1">
						<div class="flt_column_vrt_2 flt_border_column">
							<h2 class="flt_h2_ico flt_fp_ts flt_fp_ts_1">Compra 100%
								segura LojasKD</h2>
							<p>
								Não tem nada melhor do que <strong>decorar</strong> a sua casa
								de <strong>maneira prática, rápida e segura.</strong><br>

								Aqui na <strong>LojasKD,</strong> nos preocupamos com nossos
								clientes em todas as etapas do processo de Compra! Pode ter
								certeza, você esté em um <strong>site totalmente
									seguro!</strong> Possuímos o <strong>AlphaSSL da Global Sign®</strong>,
								um certificado de segurança internacional que utiliza avançadas
								tecnologias para garantir a sua segurança. A partir do
								fechamento, todas as informações </strong>são criptografadas em HTTPS</strong> e
								enviadas por meio de códigos que não podem ser interpretados,
								deixando os seus dados blindados.
							</p>

						</div>
						<div class="flt_column_vrt_2">
							<p>
								Também possuímos <strong>avaliações do consumidor no
									Google</strong>, o que demonstra a <strong>confiança e o
									comprometimento</strong> entre a <strong>LojasKD</strong> e os clientes.
								O <strong>Google Safe Browsing</strong>, selo de navegação de
								segurançaa, é outro elemento que garante que você está em um
								site seguro.
							</p>
							<br>
							<h2 class="flt_h2_ico flt_fp_ts flt_fp_ts_2">Como
								identificar a segurança?</h2>
							<p>
								A <strong>melhor forma</strong> de identificar a segurança é <strong>através
									do seu navegador</strong> (browser), ele indica se você está em uma <strong>página
									HTTPS</strong> totalmente segura. <br>Disponibilizar um site seguro
								é o mínimo que podemos oferecer para você :)
							</p>
						</div>
					</div>
				</div>
			...
			<div class="lkd-container">
				<ul class="lkd-nav lkd-nav--left">
					<li class="lkd-nav__item"><i
						...
						data-change-region> <strong data-regionalism-local>Buscando
								sua região...</strong>
					</a></li>
				</ul>
				...
				<ul class="lkd-nav lkd-nav--right">
					<li class="lkd-nav__item"><a
						...
						class="lkd-nav__link"
						onclick="trackEvent(['Topo','Barra topo','Quem somos']);">Quem
							somos</a></li>
					<li class="lkd-nav__item lkd-nav__item--dropdown"><a
						href="https://www.lojaskd.com.br/atendimento"
						title="Central de Atendimento" class="lkd-nav__link"
						onclick="trackEvent(['Topo','Barra topo','Atendimento']);">Atendimento</a>
					</li>
					<li class="lkd-nav__item"><a
						href="/blog?utm_source=lojaskd&amp;utm_medium=loja"
						target="_blank" title="Blog de decoração" class="lkd-nav__link"
						onclick="trackEvent(['Topo','Barra topo','Blog de decoração']);">Blog
							de decoração</a></li>
				</ul>
			</div>
		</nav>
			...
			<div class="lkd-container">
				<h1 class="lkd-header__logo">
					<a href="https://www.lojaskd.com.br"
						...
						class="logo" onclick="trackEvent(['Topo','Logotipo','Logotipo']);">

						<img
						src="//assets-cms.lojaskd.com.br/production/da6280e0-aa00-11e7-abfe-69e7d999ff29.png"
	...
	function arrumarUrl(){
		...
		window.location.href = "/tcc/pesquisa?pesquisa="+arg.value;
				...
				<nav class="lkd-customer-navbar is-loading" data-customer-navbar>
					<span class="lkd-customer-navbar__button" role="button"> <span
						class="hidden" data-logged="true"> <span data-user-name></span>
							...
							onclick="trackEvent(['Topo','Área do Cliente','Login']);">login</a>
							ou <a href="https://www.lojaskd.com.br/login"
							data-floater-form="#floater_form_signup"
							onclick="trackEvent(['Topo','Área do Cliente','Cadastro']);">cadastre-se</a>
							:)
					</span>
					</span>
					<ul class="lkd-dropdown list-unstyled">
						<li class="lkd-dropdown__item"><a
							...
							onclick="trackEvent(['Topo','Área do Cliente','Acompanhar Pedido']);">Acompanhar
								Pedido</a></li>
						...
						<li class="lkd-dropdown__item"><a
							...
							class="lkd-dropdown__link"
							onclick="trackEvent(['Topo','Área do Cliente','Alterar Dados']);">Alterar
								Dados</a></li>
						<li class="lkd-dropdown__item"><a
							href="https://www.lojaskd.com.br/areavip/listas"
							class="lkd-dropdown__link"
							onclick="trackEvent(['Topo','Área do Cliente','Lista de Desejos']);">Lista
								de Desejos</a></li>
				...
				<div class="lkd-header__icons">
					<a href="/tcc/desejo?produto=null&acao=ver"
						class="lkd-badge lkd-count-heart" data-noty-count="${desejo}"
						data-wishlist-count
						onclick="trackEvent(['Topo','Lista de desejos','Lista de desejos']);">
						<span class="kr-visually-hidden">Ir para lista de desejos</span> <i
						class="lkd-header__icon fa fa-heart"></i>
					</a> <a href="/tcc/carrinho?produto_kit=null&acao=ver"
						onclick="trackEvent(['Topo','Carrinho','Carrinho']);"
						class="lkd-badge" data-noty-count="${carrinho}" data-cart-count>
						<span class="kr-visually-hidden">Ir para o carrinho de
							compras</span> <i class="lkd-header__icon fa fa-shopping-cart"></i>
					</a>
				</div>
			</div>
		</div>
		<nav class="lkd-navbar lkd-navbar--primary">
			<ul class="lkd-nav">
				<li
					...
					onclick="trackEvent(['Topo','Quarto','Quarto']);"> <span>Quarto
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
				...
				<li
					...
					onclick="trackEvent(['Topo','Quarto do Bebê','Quarto do Bebê']);">
						<span>Quarto do Bebê <i
							class="lkd-icon lkd-icon--chevron-down lkd-nav__icon--position"></i></span>
				</a>
						...
						<div class="lkd-container">
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/modulados/quarto-do-bebe/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto do Bebê','Móveis']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a
									...
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto do Bebê','Ambientes']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/moveis/quarto-do-bebe/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto do Bebê','Modulados']);">
									<figure class="lkd-dropdown__image">
										<img
						...
						<div class="lkd-container">
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/modulados/quarto-infantil/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto Infantil','Móveis']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a
									...
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto Infantil','Ambientes']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/moveis/quarto-infantil/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Quarto Infantil','Modulados']);">
									<figure class="lkd-dropdown__image">
										<img
				...
				<li
					...
					onclick="trackEvent(['Topo','Cozinha','Cozinha']);"> <span>Cozinha
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
				...
				<li
					...
					onclick="trackEvent(['Topo','Escritório','Escritório']);"> <span>Escritório
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
						...
						<div class="lkd-container">
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/modulados/escritorio/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Escritório','Móveis']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a
									...
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Escritório','Ambientes']);">
									<figure class="lkd-dropdown__image">
										<img
							...
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/moveis/escritorio/"
									class="lkd-dropdown__link"
									onclick="trackEvent(['Topo','Escritório','Modulados']);">
									<figure class="lkd-dropdown__image">
										<img
				...
				<li
					...
					onclick="trackEvent(['Topo','Lavanderia','Lavanderia']);"> <span>Lavanderia
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
				...
				<li
					...
					onclick="trackEvent(['Topo','Banheiro','Banheiro']);"> <span>Banheiro
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
						...
						<div class="lkd-container">
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/modulados/banheiro/"
									...
									<figure class="lkd-dropdown__image">
										<img
											src="//assets-cms.lojaskd.com.br/production/47905430-a948-11e7-abfe-69e7d999ff29.png"
											alt="">
									</figure>
								</a>
							</div>
							<div class="lkd-dropdown__item">
								<a
									...
									<figure class="lkd-dropdown__image">
										<img
											src="//assets-cms.lojaskd.com.br/production/36db4a50-a948-11e7-abfe-69e7d999ff29.png"
											alt="">
									</figure>
								</a>
							</div>
							<div class="lkd-dropdown__item">
								<a href="https://www.lojaskd.com.br/moveis/banheiro/"
									...
									<figure class="lkd-dropdown__image">
										<img
											src="//assets-cms.lojaskd.com.br/production/3c322c30-a948-11e7-abfe-69e7d999ff29.png"
											alt="">
									</figure>
								</a>
							</div>
				...
				<li
					...
					onclick="trackEvent(['Topo','Jardim','Jardim']);"> <span>Jardim
							<i class="lkd-icon lkd-icon--chevron-down"></i>
					</span>
				</a>
				...
				<li class="lkd-nav__item lkd-nav__item--highlights"><a
					...
					class="lkd-nav__link"
					onclick="trackEvent(['Topo','Ofertas','Ofertas']);">Ofertas</a></li>
			</ul>
		</nav>
	</header>
	<header class="lkd-areavip-header">
		<a href="#lateral" role="button" class="lkd-menu-hamburger"> <span
			class="kr-visually-hidden">Abrir menu lateral</span> <i
			class="lkd-menu-hamburger__icon"></i>
		</a> <a href="/" class="lkd-logo"> <img
			src="//assets-cms.lojaskd.com.br/production/da6280e0-aa00-11e7-abfe-69e7d999ff29.png"
			alt="LojasKD.com.br - Procurou móveis, encontrou aqui!" width="185">
		</a>
	</header>
...
.bannerDes {
	...
	width: 1000px;
	background:
		url(//assets.lojaskd.com.br/campanhas/2017/acoes/para-levar-tudo-agora-nova/70/index-desc_tudo-agora.png)
...
.bannerleft {
	...
	left: 686px;
					...
					<div id="bannerFlashRelogioSky" class="bannerDes">
						...
						<div class="latA" onclick="onClickBanner()">
							<div class="stopwatch right">
								<div class="bannerleft horario" id="horario"
									style="position: absolute; cursor: default;">
									<span class="hours">00:00:00:00</span>
								</div>
							</div>
						</div>
			...
			<div id="conteudo" class="full">
				...
				<div class="agrupaTopoCarrinho clearfloat">
					<div class="titulo">
						<p class="cart_user">
							Carrinho de <strong class="client_name">karol sardo</strong>
						</p>
						<p class="info_cart_user">
							Se você não é <strong class="client_name">karol sardo</strong> <a
								href="https://www.lojaskd.com.br/sair" title="sair">clique
								aqui</a> para sair
						</p>
					</div>
					<div id="etapas">
						...
						<p>
							<b class="font16 bold">Falta muito pouco para você decorar
								sua casa.</b>
						</p>

						<img
							src="//assets.lojaskd.com.br/releases/production/dist/images/carrinho.gif"
							alt="Você está no carrinho" class="img-responsive" /> <img
							src="//assets.lojaskd.com.br/releases/production/dist/images/identificacao-off.gif"
							alt="Identificação" class="img-responsive" /> <img
							src="//assets.lojaskd.com.br/releases/production/dist/images/cadastro-off.gif"
							alt="Cadastro" class="img-responsive" /> <img
							src="//assets.lojaskd.com.br/releases/production/dist/images/pagamento-off.gif"
							alt="Pagamento" class="img-responsive" /> <img
							src="//assets.lojaskd.com.br/releases/production/dist/images/conclusao-off.gif"
							alt="Conclusão" class="img-responsive" />
					</div>
				</div>

				<a id="entendaprazo" href="javascript:void(0)"
					class="entenda-prazo-prd" title="Entenda o Prazo"
					onclick="trackEvent(['Carrinho','Entenda o Prazo','_']);"> </a>

				<div class="botoesCarrinhoSuperior">
					<form name="frm_carrinho_bt" method="post"
						action="https://www.lojaskd.com.br/carrinho.php"
						...
						<input
							...
							name="btn_fechar_compra_1" id="btn_fechar_compra_1"
							title="Finalizar Compra"
							onclick="trackEvent(['Carrinho','Finalizar compra - A','Topo']);"
							style='display: 0' /> <i
							class="imagem-bg cadeado compra-segura-medium abrirFloaterCadeado"></i>
					</form>

					<a href="https://www.lojaskd.com.br"
						title="Clique aqui para retornar a loja e continuar comprando"
						class="buttons voltar-a-comprar hidden-text"> Voltar para
						comprar mais </a>
				</div>
					...
					<div class="agrupaInfoCarrinho">
						<div id="d_carrinho_produtos">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								class="listagemPrd listagemPrdName">
								<tr class="listagemPrdNameTable">
									<th width="*" class="tituloProduto">Produtos</th>
									<th width="140" style="text-align: center;">Prazo de
										entrega <span class="lkd-tooltip lkd-tooltip--small"
										data-title="Entenda o Prazo"> <a
											class="custom-icon-question" href="javascript:void(0)"
											title="Entenda o Prazo"
											onclick="trackEvent(['Carrinho','Entenda o Prazo','ToolTip']);showAdmanagerTabs('aba3');">?</a>
									</span>
									</th>
								...
								<c:forEach items="${lista}" var="f">
									...
									<tr class="item" data-ec="true" data-ec-id="${f.id}"
										data-ec-name="Pr|73446" data-ec-item-name="${f.nome}"
										data-ec-item-category-name="Cantoneiras"
										data-ec-category="408" data-ec-price="230.39"
										data-ec-brand="Kappesberg" data-ec-variant=""
										data-ec-quantity="2" data-ec-list="" data-ec-position="0">
										<td width="400">
											<table width="100%" border="0" cellpadding="0"
												cellspacing="0" class="prds">
												<tr>
													<td width="110"><a
														href="https://www.lojaskd.com.br/cantoneira-modulada-a548-smart-100-mdf-branco-kappesberg-73446.html">
															<img
															src="<c:url value="/resources/imagem/${f.id}_lst.jpg"/>"
															alt="/resources/imagem/${f.id}_lst.jpg" class="img"
															style="width: 100px;" />
													</a></td>
													<td>
														<div class="clear">
										...
										<td style="text-align: center;">22 - 26 dias úteis</td>
										<td style="text-align: center;">R$ 230,39</td>
										<td>

											<div class="alterarQtd">
												<a data-ec-click="removeCard" href="javascript:void(0);"
													onclick="javascript:remover_produto('', '', '73446', '27176839', '', '');"
													class="ico-remover"> Retirar do carrinho </a> <input
													name="qtd[73446]" type="text" class="qtd" value="2"
													onkeypress="return OnlyNumber(event)" maxlength="3"
													onblur="javascript:atualiza_quantidade( '', '', '73446', '27176839', this.value, '');"
													size="2" /> <input name="removerPrdsCarrinho_73446"
													class="removerPrdsCarrinho" value="73446|27176839"
													type="hidden" /> <a data-ec-id="73446" href="#"
													class="ico-alterar">Alterar quantidade</a><br />
										...
										<td class="text_black">
											<div class="produtoPrecoTotal">
												R$ 460,78 <br>
												<span style="color: #67a039;">R$ 423,92 à vista</span>
											</div>
										</td>
									</tr>
						...
						<div id="d_carrinho_orcamento">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td colspan="3"><a href="#"
										class="buttons limpar-carrinho hidden-text"
										id="btn_limpar_carrinho"
										...
										title="Esvaziar carrinho"> Limpar carrinho </a></td>
									<td>
										<div class="box-economy left hidden">
											<div class="subbox-economy">
												<label class="economize-economy">Voc&ecirc;
													est&aacute; economizando:</label> <label class="price-economy bold">R$<span
													class="bold">1.942,33</span></label>
											</div>
										</div>
									</td>
									<th class="ad" width="140">Sub total</th>
									<td width="140" class="text_black"><span
										id="carrinho_sub_total"> R$ 4.267,52 <br>
										<span style="color: #67a039;">R$ 3.926,12 à vista</span>
									</span></td>
								</tr>
							</table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td width="280" class="ad ad-cod-desc" valign="top">
										<p class="font14">
											<strong>C&oacute;digo de desconto (opcional)</strong>
										</p>
										<p>
											<small class="font11">Digite ao lado o c&oacute;digo
												que voc&ecirc; possui</small>
										</p>
									</td>
									<td width="150" class="ad frm-cod-desc">
										<form name="frm_vale_compra" method="post" action="#"
											onsubmit="return false;" class="vale-compras">
											<div class="div-input">
												<input name="vale" id="vale" type="text" class="input"
													placeholder="CUPOM" value=""
													onkeyup="javascript:alta(this);"
													onkeypress="doClick('bto_aplicar_valecompra', event);"
													size="12" />
											</div>
											<div class="div-input">
												<input name="button" type="button"
													id="bto_aplicar_valecompra" class="buttons ok"
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								class="listagemPrd" id="fretecarrinho">
								<tr>
									<td colspan="3"></td>
									<td class="ad" width="140"><span class="font14"><strong>Montagem</strong></span>
										<br /> <small><a href="javascript:void(0)"
											onclick="showAdmanagerTabs('aba5');"
											title="Clique aqui para saber mais sobre a montagem"
											onclick="trackEvent(['Montadores','Carrinho','Saiba mais abaixo']);">Saiba
												mais</a></small></td>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td width="280" valign="top">
										<form name="frm_carrinho" method="post" action="#"
											onsubmit="return false;">
											<p class="font14">
												<strong>Digite o CEP de entrega:</strong>
											</p>
											<p>Veja o valor e prazo de entrega ate seu
												endere&ccedil;o.</p>

											<div class="div-input inputs">
												<input name="cep_a"
													onkeyup="return NextField(document.frm_carrinho.cep_a, document.frm_carrinho.cep_b, 5);"
													type="text" size="5" class="input-cep1 " maxlength="5"
													value="80001" /> <input name="cep_b" type="text" size="2"
													class="input-cep2" maxlength="3" value="970" /> <br />
												...
												<a
													href="javascript:openWindow('http://www.buscacep.correios.com.br','yes','1000','400','');"
													title="Clique aqui caso nao lembre seu CEP"> <small>N&atilde;o
														lembro meu CEP</small>
												</a>
											</div>
											<div class="div-input">
												<input type="button" name="bto_calcula_frete"
													class="buttons calcular-frete" value=""
									...
									<td width="140" class="ad" valign="top"><span
										class="font14"><strong>Entrega entre</strong></span> <br>
										<a href="javascript:void(0)" title="Entenda o Prazo"
										onclick="trackEvent(['Carrinho','Entenda o Prazo','Link']);showAdmanagerTabs('aba3');">
										...
										<div id="d_frete">
											...
											<div class="clearfix"></div>
											<a href="javascript:void(0)" title="Entenda o fretinho"
												onclick="trackEvent(['Carrinho','Entenda o fretinho','Link']);showAdmanagerTabs('aba4');">
												<small>Entenda o fretinho</small>
											</a>
										</div>
										<div id="d_desconto_frete">
											<span class="font12"><strong>Valor do
													desconto</strong></span>
										</div>
										<div id="d_frete_com_desconto">
											<span class="font14"><strong>Frete com
													desconto</strong></span>
										</div></td>
							...
							<table id="listagemPrdBlock" width="100%" border="0"
								cellpadding="0" cellspacing="0" class="listagemPrd tableTotal">
								<tr>
									<th class="ae font22" width="550"></th>
									<th class="ad font22" width="140" style="padding-bottom: 0;">Total
										&agrave; vista<small><sup>*</sup></small>
									</th>
									<th width="250" class="text_ligth_gray font22"
										style="text-align: right; padding-right: 20px; padding-bottom: 0;">
										<span id="carrinho_valor_total" style="text-align: right;">R$
											4.091,86</span>
										<div class="font11">8% de desconto &agrave; vista</div>
									</td>
								</tr>

								<tr>
									<th class="ae font22" width="550"></th>
									<th class="ad font16" width="140" style="padding-bottom: 0;"><small>Total
											&agrave; prazo</small></th>
									<th width="250" class="text_ligth_gray font18"
										style="text-align: right; padding-right: 20px; padding-bottom: 0;">
										<span id="carrinho_valor_total" style="text-align: right;">R$
											4.433,26</span>
										<div class="font11">em at&eacute; 10x de 443,33 s/ juros
										</div>
									</th>
								</tr>
								...
								<tr class="ultimaLinha">
									<td colspan="3" style="padding-left: 10px; text-align: right;">
										<small style="color: #aaa;"><sup>*</sup> Desconto de
											8% de desconto para pagamentos em at&eacute 1x no
											cart&atildeo de cr&eacutedito, boleto ou dep&oacutesito
											banc&aacuterio.</small>
									</td>
								</tr>
							...
							<div class="botoesCarrinho border clearfloat">
								<form name="frm_carrinho_bt" method="post"
									action="https://www.lojaskd.com.br/carrinho.php"
									onsubmit="trackEvent(['_linkByPost', this])">
									<input type="image" name="btn_fechar_compra_2"
										id="btn_fechar_compra_2" title="Finalizar Compra"
										src="//assets.lojaskd.com.br/releases/production/dist/images/pixel.gif"
										class="buttons finalizar-compra-large hidden-text right comprar"
			...
			<div class="depoimentorodape"></div>
			<div class="clearfix"></div>
		</div>
		<!-- final #wrap -->
	</div>
	<!-- adicionado para fechar wrap -->
	...
	<script language="javascript" type="text/javascript"
		src="//assets.lojaskd.com.br/releases/production/dist/javascripts/desktop-fc.min.js"></script>
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"aa62a0219f","applicationID":"32273587,32273588","transactionName":"MVABZxcDChIEUkBRCwgaIlARCwsPSnJVShBJXA1XABo=","queueTime":0,"applicationTime":787,"atts":"HRcCEV8ZGRw=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>
</html>